...
$(document).ready(function() {
	...
	// alert(value);
		switch (value) { 
		case 1: 
			var fly = new Fly("test", "Nháº·ng", "Äen", height_fly, width_fly, 0, 0, "https://storage.fshare.vn/web/flies.png", "Long ruá»“i");	
			break;
		case 2: 
			var fly = new Fly("test", "Nháº·ng", "Xanh", height_fly, width_fly, 0, 0, "https://storage.fshare.vn/web/style_1.png", "King ruá»“i");
			break;
		case 3: 
			var fly = new Fly("test", "Nháº·ng", "Tuyá»‡t sáº¯c", height_fly, width_fly, 0, 0, "https://storage.fshare.vn/web/style_2.png","Tom ruá»“i");
			break;		
		case 4: 
			var fly = new Fly("test", "Nháº·ng", "Há»“ng", height_fly, width_fly, 0, 0, "https://storage.fshare.vn/web/style_3.png", "Queen ruá»“i");
			break;
		}
		fly.move();	

	if(var_2 == 'true'){
		var fly2 = new Fly("test", "Nháº·ng", "Xanh", height_fly, width_fly, 0, 0, "https://storage.fshare.vn/web/style_1.png", "King ruá»“i");
		// var fly3 = new Fly("test", "Nháº·ng", "Tuyá»‡t sáº¯c", 0, 0, 0, 0, "https://storage.fshare.vn/web/style_2.png","Tom ruá»“i");
		// var fly4 = new Fly("test", "Nháº·ng", "Há»“ng", 0, 0, 0, 0, "https://storage.fshare.vn/web/style_3.png", "Queen ruá»“i");
		fly2.move();
		fly2.flying();
		// fly3.move();
		// fly4.move();
