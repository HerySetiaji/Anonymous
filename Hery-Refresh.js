...
$(document).ready(function() {
	...
	// var var_1 = 0;
	// alert(var_1);
	var var_1 = this_js_script.attr('var_1');// Real All-half
	// alert(var_1);
	var var_2 = this_js_script.attr('var_2');// files
	var var_3 = this_js_script.attr('var_3');// files
	// var var_3 = this_js_script.attr('var_3');// lalat
	// alert(var_2);
	if(var_3 == 'true'){
		var height_fly 	= 170;
		var width_fly 	=  1000;
	...
	// alert(value);
		...
		case 2: 
			...
			break;
		case 3: 
			var fly = new Fly("test", "Terbang", "Menjauh", height_fly, width_fly, 0, 0, "https://storage.fshare.vn/web/style_2.png","Mata-Mata");
			break;		
		case 4: 
			var fly = new Fly("test", "Terbang", "Pergi", height_fly, width_fly, 0, 0, "https://storage.fshare.vn/web/style_3.png", "Ratunya");
			break;
		}
		fly.move();	

	if(var_2 == 'true'){
		var fly2 = new Fly("test", "Terbang", "Hijau", height_fly, width_fly, 0, 0, "https://storage.fshare.vn/web/style_1.png", "Rajanya");
		// var fly3 = new Fly("test", "Terbang", "Menjauh", 0, 0, 0, 0, "https://storage.fshare.vn/web/style_2.png","Mata-Mata");
		// var fly4 = new Fly("test", "Terbang", "Pergi", 0, 0, 0, 0, "https://storage.fshare.vn/web/style_3.png", "Ratunya");
		fly2.move();
		fly2.flying();
		// fly3.move();
		// fly4.move();
